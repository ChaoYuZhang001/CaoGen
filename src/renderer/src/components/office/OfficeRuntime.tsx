...
// These trees are not needed for the first interactive boot frame. Keeping
// them behind Suspense prevents the cold control-room route from parsing the
// full scene and character rigs before the lightweight boot scene is usable.
const OfficeScene = lazy(() => import('./kit/OfficeScene'))
const WorkstationPro = lazy(() => import('./kit/WorkstationPro'))
const AgentWalkers = lazy(() => import('./kit/AgentWalkers'))
...
export default function OfficeView(): React.JSX.Element {
  ...
  const { bootCharactersEnabled, bootCharactersReadyAt, sceneDetailEnabled, sceneAssetsEnabled, handleOfficeFrame } =
    ...
    <div className="office">
      ...
      {hydrated && operationalDataReady && !hasAnyOperations ? (
        ...
        <div
          ...
          data-office-desk-workers={deskRobotCount} data-office-visible-digital-workers={deskRobotCount + awaySessionIds.size} data-office-3d-workers-ready-at={bootCharactersReadyAt}
