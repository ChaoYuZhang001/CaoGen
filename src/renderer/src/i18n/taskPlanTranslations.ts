export const TASK_PLAN_TRANSLATIONS = {
  ...
  taskPlanExecuting: { zh: '执行中', en: 'Running' },
  taskPlanExecutionComplete: { zh: '执行完成', en: 'Completed' },
  taskPlanExecutionFailed: { zh: '执行失败', en: 'Failed' },
  ...
  taskPlanStepArtifacts: { zh: '步骤预期产物', en: 'Step artifacts' },
  taskPlanStepDataEgress: { zh: '步骤数据外发', en: 'Step data egress' },
  taskPlanStepRisk: { zh: '步骤风险', en: 'Step risk' },
