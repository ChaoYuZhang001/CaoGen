...
const PROJECT_OWNED_ACTIONS = new Set([
  ...
  'proposeDigitalWorkerMemory', 'approveDigitalWorkerMemory', 'rejectDigitalWorkerMemory',
  'revokeDigitalWorkerMemory', 'deleteDigitalWorkerMemory',
...
export function digitalWorkerMutationProjectIds(
  ...
  const idValue = payload.id ?? payload.workerId
