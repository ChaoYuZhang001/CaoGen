...
- M1 招募已公开：`npm run prepare:m1-first-user-drill` 会在仓库外创建权限收紧的私有目录、记录模板和主持人清单，不下载 DMG、不创建假证据；中英文 [Discussion #9](https://github.com/ChaoYuZhang001/CaoGen/discussions/9) 只征集 Intel 机型、时区和可参与时间，并明确禁止公开 Key、Provider URL、项目路径、录屏或证据。当前合格参与者和真人记录仍为 0，不能关闭 M1。
