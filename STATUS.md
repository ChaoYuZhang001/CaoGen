...
> 当前源码已按 `docs/PLAN.md` 的用户问题 patch 规则完成 `0.1.8` Intel-only 未发布候选验证。精确 `main@837f8f90945d558c44b2d05cbc09a24e93d1202f` 已通过 clean Deep、签名、公证、安装、renderer 与五资产绑定，但尚未创建 tag 或 Release。v0.1.7 仍是最新公开版，也不是正式 1.0 stable：PRD 64 个 P0 = 21 个已验证 + 18 个部分完成 + 24 个立项目标 + 1 个仅达到基础。执行边界见 `docs/1.0-ACCEPTANCE-MATRIX.md`；0.1.8 只允许交付已验证补丁，不把路线图能力写成已完成。
>
