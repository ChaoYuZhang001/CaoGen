...
> 更新:2026-07-06 · 实测口径,非文档自评。此文件为活文档,Current Focus 随日更新。
...
- **v0.1.1 已公开发布**(2026-07-06,DMG + zip + 自动更新元数据,未签名 x64)
...
**用户日常真用 → 毛刺当天修。** 辅线:arm64 打包(M 系 Mac 免 Rosetta)。
...
2. **分发摩擦**:未签名(首开需右键)+ 仅 x64(M 系跑 Rosetta),真实用户流失点
