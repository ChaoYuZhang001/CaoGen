...
> 更新:2026-07-14(第 28 次)· 实测口径,非文档自评。此文件为活文档,Current Focus 随日更新。
>
...
- **v0.1.5 macOS x64 发布候选**(2026-07-14,五个本地资产已生成,尚未上传)——Intel 主二进制已验证为 `x86_64`,DMG 与 zip 完整性通过,arm64/Windows/Linux 不在本轮发布范围
...
- v0.1.5 最终发布说明保存在 `docs/RELEASE-NOTES-FINAL.md`;只有在精确 release commit 的干净工作树上通过 `npm run test:release-notes-audit:final` 后才能用作 GitHub Release 正文。
- Packaging gate 候选资产已由 `npm run dist:mac:x64` 生成:v0.1.5 macOS x64 DMG/zip、两个 blockmap 与 `latest-mac.yml` 的资产集 SHA256 为 `15990fe33a095305021b996ae88a7ff9b54345606a88569a2fdfd4c58fd6ca65`。macOS 包仍未签名,Release notes 保留首次打开说明。
