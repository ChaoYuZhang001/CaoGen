...
| 新最终候选 Deep | High | ⏳ `e8f617f8` 的 Intel-only run `30150795350` 已在 clean exact commit 上通过 `155/155` required，但发布预检源码变化后只保留为历史证据；必须在本轮新提交上重跑，2 项 optional skip 仍不得计作 pass |
