...
try {
  ...
  assertEqual(commands[0].title, '/agent Review Agent')
  assertEqual(commands[1].title, '/plugin browser')
  assertEqual(commands[2].title, '/skill openai-docs')
  assertEqual(commands[0].action, 'dispatch-agent')
  assertEqual(commands[2].action, 'use')
  ...
  assert(slash.pluginSlashCommandMatches(commands[2], 'openai'), 'search should match item names')
  assert(slash.pluginSlashCommandMatches(commands[2], 'official'), 'search should match summaries')
  assert(slash.pluginSlashCommandMatches(commands[1], 'codex'), 'search should match sources')
  assert(!slash.pluginSlashCommandMatches(commands[1], 'linear'), 'search should reject unrelated terms')
