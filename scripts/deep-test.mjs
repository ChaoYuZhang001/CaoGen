...
const commandDefinitions = [
  ...
  { name: 'Watercolor runtime assets required', ...commandSpec('npm', ['run', 'test:watercolor-assets:required']), category: 'static' },
  ...
  { name: 'Office quality policy smoke', command: 'node', args: ['scripts/office-quality-policy-smoke.mjs'], category: 'static' },
  { name: 'Office performance required UI e2e', command: 'node', args: ['scripts/office-performance-smoke.mjs', '--required'], category: 'performance' },
  ...
  { name: 'private Provider config smoke', command: 'node', args: ['scripts/private-provider-config-smoke.mjs'], category: 'smoke' },
  { name: 'private Provider report redaction smoke', command: 'node', args: ['scripts/private-provider-report-redaction-smoke.mjs'], category: 'smoke' },
  { name: 'task strategy smoke', command: 'node', args: ['scripts/task-strategy-smoke.mjs'], category: 'smoke' },
  { name: 'task strategy derive smoke', command: 'node', args: ['scripts/task-strategy-derive-smoke.mjs'], category: 'smoke' },
  ...
  { name: 'Windows unsigned preview config audit', command: 'node', args: ['scripts/windows-release-audit.mjs', '--preview', '--config-only'], category: 'static' },
  ...
  { name: 'chat ergonomics smoke', command: 'node', args: ['scripts/chat-ergonomics-smoke.mjs'], category: 'smoke' },
  { name: 'chat ergonomics Electron E2E', command: 'node', args: ['scripts/chat-ergonomics-e2e.mjs'], category: 'ui' },
  ...
  { name: 'DigitalWorker retirement history required', command: 'node', args: ['scripts/digital-worker-history-required.mjs'], category: 'system' },
  ...
  { name: 'team recommendation required', command: 'node', args: ['scripts/team-recommendation-smoke.mjs'], category: 'smoke' },
  { name: 'digital worker memory required', command: 'node', args: ['scripts/digital-worker-memory-smoke.mjs'], category: 'smoke' },
  { name: 'worker performance required', command: 'node', args: ['scripts/worker-performance-smoke.mjs'], category: 'smoke' },
  ...
  { name: 'Conversation Ledger archive and recovery smoke', command: 'node', args: ['scripts/conversation-ledger-smoke.mjs'], category: 'system' },
  { name: 'Provider cross-resume restart E2E', command: 'node', args: ['scripts/provider-cross-resume-e2e.mjs'], category: 'system' },
  { name: 'checkpoint Effect boundary smoke', command: 'node', args: ['scripts/checkpoint-effect-boundary-smoke.mjs'], category: 'system' },
  { name: 'canonical domain restart parity strong-kill E2E', command: 'node', args: ['scripts/domain-restart-parity-e2e.mjs'], category: 'system' },
  { name: 'standalone Session deletion strong-kill recovery E2E', command: 'node', args: ['scripts/session-deletion-recovery-e2e.mjs'], category: 'system' },
  ...
  { name: 'Office delivery required system gate', command: 'node', args: ['scripts/office-delivery-required.mjs'], category: 'system' },
  { name: 'verified delivery staged-flow required gate', command: 'node', args: ['scripts/verified-delivery-flow-required.mjs'], category: 'system' },
  { name: 'Notification Effect required system gate', command: 'node', args: ['scripts/notification-effect-required.mjs'], category: 'system' },
  ...
  { name: 'Project ownership required smoke', command: 'node', args: ['scripts/project-ownership-smoke.mjs'], category: 'system' },
  { name: 'WorkItem board required UI e2e', command: 'node', args: ['scripts/workitem-board-required.mjs'], category: 'ui' },
  { name: 'Project templates required smoke', command: 'node', args: ['scripts/project-templates-smoke.mjs'], category: 'smoke' },
  { name: 'Connector resource required smoke', command: 'node', args: ['scripts/connector-resource-smoke.mjs'], category: 'smoke' },
  { name: 'WorkItem transfer required smoke', command: 'node', args: ['scripts/work-item-transfer-smoke.mjs'], category: 'system' },
  ...
  { name: 'routing commercial neutrality required', command: 'node', args: ['scripts/routing-commercial-neutrality-smoke.mjs', '--required'], category: 'integration' },
  ...
  { name: 'Effect entry inventory required system gate', command: 'node', args: ['scripts/effect-entry-inventory-required.mjs'], category: 'system' },
  { name: 'Durable write inventory required system gate', command: 'node', args: ['scripts/durable-write-inventory-required.mjs'], category: 'system' },
  { name: 'durable direct-write recovery required', command: 'node', args: ['scripts/durable-direct-write-recovery-smoke.mjs'], category: 'system' },
  { name: 'external Effect recovery required system gate', command: 'node', args: ['scripts/external-effect-recovery-e2e.mjs'], category: 'system' },
  ...
  { name: 'Session query smoke', command: 'node', args: ['scripts/session-query-smoke.mjs'], category: 'smoke' },
