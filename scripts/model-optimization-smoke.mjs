...
function assertRuntimeMonthlyBudgetWiring() {
  ...
  assert(agentSession.includes('calculateMonthlyBudgetSnapshot'), 'auto routing must calculate monthly budget')
  assert(agentSession.includes('monthlyBudgetRemainingUsd'), 'auto routing must pass monthly remaining budget')
