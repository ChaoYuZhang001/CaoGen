...
- [x] M1-T6 发布 v0.1.7,Release Notes 只写当前真实能力,不写路线图功能
  ...
  - [ ] 等待期功能修复收口后重跑 v0.1.8 clean Intel 候选，再把新候选的精确五资产和四类报告写入 Final Notes，并在 clean publication-only 后继提交上通过 scoped notes/handoff preflight；`1707a999 / 30235833246` 已完成 exact-commit Deep `163/161`、`120/120` audit、签名/公证/安装/renderer 和五资产绑定，Actions artifact `8642130786` 也已独立重组并核验 ZIP digest `e4d616537676a461ba40725319a9ec422e4f02f6ad2092ed1fce456a5f980107` 与资产集 `756968f38c312b4df2dd9d4b53421ca838c7eec9ff5aab2153d07ec59e321b28`，但已被后继 Browser 修复超越，只保留为历史签名证据。获得创始人针对 v0.1.8 的新授权后才可创建 tag/Release
